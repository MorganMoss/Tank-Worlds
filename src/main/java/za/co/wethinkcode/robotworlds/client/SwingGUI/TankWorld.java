// TODO : I commented this out so that I don't get errors for the meantime
//  I'd suggest refactoring this to align better with the interface
//  and to not have any code for this GUI outside of the SwingGUI package
//  (i.e. don't do anything in the Client other than change TextGUI to SwingGUI when it is constructed)
